...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		//creation of the second instance of UnfoldingMap with the new map on the side
		//of the first one. I just changed the x parameter.
		map2 = new UnfoldingMap(this, 450, 50, 300, 500, provider2);

		//zoom in and center the map at my location
		map2.zoomAndPanTo(zoomLevel, new Location(45.74f, 9.48f));
